<div class="content-wrapper">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a
                                href="<?=base_url()?>c_admin/departemen"><?= $dashboard; ?></a></li>
                    </ol>
                </div>
            </div>
    ...
    <section class="content fadeInLeft animated">
        <div class="container-fluid">
            <div class="row">
                <?php
                    foreach ($mastersubdepartemen as $sub) { ?>
                <div class="col-12 col-sm-6 col-md-2">
                    <a href="<?= $sub->textLinkSub; ?>" type="button" class="text-dark">
                        <div class="info-box">
                            <span class="info-box-icon bg-info elevation-1"><img src="<?= $sub->textLogoSub; ?>"
                                    style="width: 50px; height: 50px;" class="img-circle" alt="User Image"></span>
                            <div class="info-box-content">
                                <span class="info-box-number" style="font-size: 12px;"><?= $sub->textNamaSub; ?></span>
                                <span class="info-box-text"
                                    style="font-size: 12px;"><small><?= $sub->dtmInserted; ?></small>
                                </span>
                            </div>
                        </div>
                    </a>
