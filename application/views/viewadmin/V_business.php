<div class="content-wrapper">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form" action="<?=base_url()?>c_admin/insert_subbusiness" method="POST" enctype="multipart/form-data" role="form">
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group form-group-default">
                  <label>Nama Sub Departemen</label>
                  <input id="addSubDept" type="text" class="form-control" name="textSubDept" placeholder="Contoh: Quality  Inspection">
                </div>
  ...
  <section class="content fadeInLeft animated">
    <?= $this->session->flashdata('messagemodalbusiness'); ?> 
    <div class="container-fluid">
      <div class="row">
        <?php
        foreach ($masterbusiness as $business) { ?>
          <div class="col-12 col-sm-6 col-md-2">
            <a href="<?= base_url() ?>c_business/subbusiness/<?=$business->intNo; ?>" type="button" class="submit text-dark">
              <div class="info-box">
                <span class="info-box-icon bg-info elevation-1"><img src="<?= $business->textLogoDept; ?>"  style="width: 60px; height: 60px;" class="img-circle" alt="User Image"></span>
                <div class="info-box-content">
                  <span class="info-box-number" style="font-size: 12px;"><?= $business->textNamaDept; ?></span>
                  <span class="info-box-text" style="font-size: 12px;">
                    <small><?= $business->dtmCreated; ?></small>
                  </span>
                </div>
              </div>
            </a>
